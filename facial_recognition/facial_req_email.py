...
def send_message(name):
        ...
        server.starttls()
        server.login("projectpijesse@gmail.com","myPassword")
        msg= name + " is at the door."
        server.sendmail("projectpijesse@gmail.com","jesse.gabriels13@gmail.com",msg)
        server.quit()
        ...
        #data={"from": 'camera@sandboxd0830df8d79b47e4bfe3f26f76dcb117.mailgun.org',
        #    "to": ["jesse.gabriels13@gmail.com"],
